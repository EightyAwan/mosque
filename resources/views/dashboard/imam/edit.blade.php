    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('imam.update', $user->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6" name="is_irc">
                                <select class="form-control" name="is_irc">  
                                    <option value="no" {{ ($user->is_irc_imam === "no") ? "selected" : "" }}>No</option> 
                                    <option value="yes" {{ ($user->is_irc_imam === "yes") ? "selected" : "" }}>Yes</option> 
                                </select> 
                                @error('is_irc')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
